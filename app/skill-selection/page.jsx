          ...
          <div className="lg:col-span-3">
            <div className="relative bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl p-8 border border-white/20 overflow-hidden">
              ...
              <div className="relative z-10">
                      ...
                      >
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                          {category.skills.map((skill) => (
                            <button
                              key={skill.id}
                              className="p-3 rounded-lg border-2 border-gray-200 hover:border-gray-300 hover:bg-gray-50 transition-all duration-200 text-left"
                            >
                ...
                {/* Submit Button */}
                <div className="pt-4">
                  <button className="w-full bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 text-white py-5 rounded-2xl font-bold text-lg transition-all duration-300 hover:shadow-2xl transform hover:-translate-y-2 hover:scale-[1.02] flex items-center justify-center gap-4 relative overflow-hidden group">
                    {/* Button glow effect */}
